...
# 去除假设检验不通过的
delnames = [ 'pco2_max','bicarbonate_max','wbc_avg','rbc_min','platelet_avg',
             'creatinine_avg','heartrate_max','diasbp_mean','diasbp_min','meanbp_mean',
             'spo2_max','vent','vaso','diure']#25789个样本假设检验不通过的
...
dataMat = OF.standarddata(dataMat)
...
for train, test in skf.split(dataMat, labelMat):
    ...
    # clf = MLPClassifier(hidden_layer_sizes=(46,),#9,10
    #                     activation='tanh',
    #                     shuffle=True,
    #                     solver='sgd',
    #                     alpha=1e-6,
