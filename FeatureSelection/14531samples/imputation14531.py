...
#加载数据
data=pd.read_csv('./data/final14531.csv')
...
nullpercent=data.count()/14531#统计每个特征值的缺失比例
...
data.to_csv('./data/outlier14531.csv')#最终用于机器学习模型中的完整数据集
